...
sudo apt-get install python-gtk2 python-cairo python-usb python-crypto python-serial python-dev libgcrypt-dev git
...
printf "\n\n${GREEN}[*] Creating directory for Pcap files ${NORMAL}\n\n"
mkdir pcap
