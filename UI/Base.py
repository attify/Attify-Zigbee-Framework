...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ToolIcon.setPixmap(QtGui.QPixmap(_fromUtf8("../../.designer/backup/icon.png")))
        ...
        self.zbreplayFile = QtGui.QLineEdit(self.frame_2)
        self.zbreplayFile.setGeometry(QtCore.QRect(200, 140, 113, 21))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Attify Killerbee Framework", None))
